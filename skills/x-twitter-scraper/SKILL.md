...
|----------------------|------------------|-------|
| Install SDK | `npm install x-developer@2.5.3` | Use only when code integration needs the package. |
| Check package metadata | `npm view x-developer@2.5.3 version license repository.url homepage --json` | Confirms version, license, repository, and docs home. |
| Read API docs | `https://docs.xquik.com/api-reference/overview` | Treat docs as source truth. |
| Read MCP docs | `https://docs.xquik.com/mcp/overview` | Supports OAuth 2.1 or API key access through 2 MCP tools. |
